...
public class SecurityController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Security> updateSecurity(@PathVariable("id") Long id,
                                                   @RequestBody SecurityUpdateDto securityDto) {

        log.info("Request: update security id = {}", id);
        log.debug("Update security payload: {}", securityDto);
        Security updatedSecurity = securityService.updateSecurity(id, securityDto);

        log.info("Security updated id = {}", id);
